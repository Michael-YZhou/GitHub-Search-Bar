...
/*
    request GitHub：http://localhost:3000/search/users?q=aa  

    request local data：http://localhost:3000/search/users2?q=aa
    data format：
    key： /search/users
    value： function () {}
*/
...
app.listen(5000, "localhost", (err) => {
  if (!err) {
    ...
    console.log("request GitHub：http://localhost:5000/search/users");
    console.log("request local data：http://localhost:5000/search/users2");
